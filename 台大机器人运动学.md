...
- **joint：**
  ...
  - 每个joint对某特定axis进行**rotation**（转动）或**translation**（移动）；
...
- 对空间中2个任意方向的axes，两axes之间具有一线段和此2个axes都相互垂直；

![](https://cdn.jsdelivr.net/gh/KKMJJ0721/Blog_pic/202510012143439.png)
